        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>修改项目<small class="m-l-sm">Now,开启你的投票之旅吧!</small></h5>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal m-t" id="form1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="votename" name="votename" class="form-control" type="text" value="<?php echo ($res["votename"]); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="voteway" id="voteway">
                                            <?php if($res["voteway"] == '每日限投N票(不可重复投给一个人)'): ?><option value="每日限投N票(不可重复投给一个人)" selected='selected'  >每日限投N票(不可重复投给一个人)</option>
                                                <option value="一次投N票(不可重复投给一个人)">一次投N票(不可重复投给一个人)</option>

                                                <?php else: ?>
                                                <option value="每日限投N票(不可重复投给一个人)"   >每日限投N票(不可重复投给一个人)</option>
                                                <option value="一次投N票(不可重复投给一个人)"
                                                        selected='selected'>一次投N票(不可重复投给一个人)</option><?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="votenums" name="votenums" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error"  value="<?php echo ($res["votenums"]); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input placeholder="开始日期" class="form-control layer-date" id="startime"  name="startime" type="text"  value="<?php echo ($res["startime"]); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input placeholder="结束日期" class="form-control layer-date" id="endtime" name="endtime" type="text"  value="<?php echo ($res["endtime"]); ?>">
                                    </div>
                                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal m-t" id="form2" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <label for="doc2">
                                            <img id="preview2" src="<?php echo ($res["homepic"]); ?>"
                                                 style="display:block;width: 130px;height: 130px;"/>
                                        </label>
                                        <input  id="doc2"  name="file2" type="file" onchange="javascript:setImagePreview2();" style="position:absolute;clip:rect(0 0 0 0);" id="file2">

                                        <input type="hidden" name="isimg" value="<?php echo ($res["homepic"]); ?>"  id="isimg" class="form-control"  />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" rows="3" id="picdes" name="picdes" ><?php echo ($res["picdes"]); ?></textarea>
                            ...
                            <form class="form-horizontal m-t" id="form3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <select class="form-control" name="templateid" onchange="setImg()" id="templateid">
                                            <?php if($res["templetid"] == '模板一'): ?><option value="模板一" selected='selected'>模板一</option>
                                                <option value="模板二">模板二</option>
                                                <option value="模板三">模板三</option>
                                                <option value="模板四">模板四</option>
                                             <?php elseif($res["templetid"] == '模板二'): ?>
                                                <option value="模板一">模板一</option>
                                                <option value="模板二" selected='selected'>模板二</option>
                                                <option value="模板三">模板三</option>
                                                <option value="模板四">模板四</option>
                                                <?php elseif($res["templetid"] == '模板三'): ?>
                                                <option value="模板一">模板一</option>
                                                <option value="模板二">模板二</option>
                                                <option value="模板三" selected='selected'>模板三</option>
                                                <option value="模板四">模板四</option>
                                                <?php else: ?>
                                                <option value="模板一">模板一</option>
                                                <option value="模板二">模板二</option>
                                                <option value="模板三" >模板三</option>
                                                <option value="模板四" selected='selected'>模板四</option><?php endif; ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <?php if($res["templetid"] == '模板一'): ?><img id="template_img" src="/tpb/Public/img/mb1.jpg"
                                                 style="display:block;width: 250px;height: 350px;"/>

                                            <?php elseif($res["templetid"] == '模板二'): ?>

                                            <img id="template_img" src=" /tpb/Public/img/mb2.png"
                                                 style="display:block;width: 250px;height: 350px;"/>

                                            <?php elseif($res["templetid"] == '模板三'): ?>
                                            <img id="template_img" src=" /tpb/Public/img/mb3.png"
                                                 style="display:block;width: 250px;height: 350px;"/>
                                            <?php else: ?>
                                            <img id="template_img" src=" /tpb/Public/img/mb4.png"
                                                 style="display:block;width: 250px;height: 350px;"/><?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="summernote" name="voterule">
                                           <?php echo ($res["voterule"]); ?>
                                        </div>
                                    </div>
                                </div>
                                <!--投票规则-->
    ...
    $(document).ready(function () {
        ...
        $("#form3").validate({
            ...
            submitHandler: function(form) {
                ...
                $(form).ajaxSubmit({
                    url: "<?php echo U('Vote/saveUpdate');?>",
                    type: "post",
                    data:{
                        'id':"<?php echo ($res["id"]); ?>",
